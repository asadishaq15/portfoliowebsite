    ...
    return (
        ...
        >          <div className="border-[1px] border-gray-200 rounded-[50px] p-8 mx-[40px] overflow-hidden">
                ...
                <link
                    ...
                    rel="stylesheet"
                />
                <div className="max-w-8xl mx-auto md:px-4 md:py-2 md:mb-2 flex flex-col md:flex-row ">

                    <div className="w-full md:w-3/10  md:pl-4 order-last md:order-none ">
                    ...
                    </div> <div className="w-full md:w-7/10 md:pr-2 relative  md:mb-0 order-first md:order-none">
