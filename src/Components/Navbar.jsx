...
const Navbar = () => {
    ...
    return (
      <div className="fixed w-full z-50 flex justify-center items-center px-4 top-4">
        <nav
        ...
        >
          ...
          <div className="hidden md:flex items-center space-x-4">
           ...
           <div className="hidden md:block">
            <Link
              to="/contact"
              className="bg-white text-black px-6 py-2 rounded-full hover:bg-orange-500 hover:text-white transition-colors duration-300 font-syne text-lg"
            >
              Let's Talk
            </Link>
          </div>
